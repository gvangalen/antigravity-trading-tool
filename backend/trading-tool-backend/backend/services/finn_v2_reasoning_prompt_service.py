        ...
        *,
        ...
        if repair_attempt:
            ...
            return (
                ...
                "When a saved configuration is relevant but no outcome evidence exists, retain the factual value and state "
                "that the available evidence does not establish the outcome; that evidence-boundary statement is valid and "
                "must not be replaced with a new causal diagnosis. "
