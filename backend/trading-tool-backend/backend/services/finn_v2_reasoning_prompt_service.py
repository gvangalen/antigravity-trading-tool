    ...
    def build_user_prompt(
        ...
        *,
        ...
        repair_instruction = (
            ...
            "the supplied evidence explicitly supports that relationship. This includes freshness labels such as stale "
            "or verouderd: they may be reported as their saved status, but cannot imply uncertainty, delay, performance "
            "impact, or a plan weakness. A saved boolean must retain its exact polarity; do not turn false into a "
