...
class FinnV2ResponseDowngradeService:
    ...
    def downgrade_to_unavailable(self, *, draft: ResponseDraft, reason: Optional[str]) -> ResponseDraft:
        return ResponseDraft(
            ...
            main_observation="De beschikbare context kon deze reactie niet volledig en veilig onderbouwen.",
            supporting_points=[],
            claims=[],
            evidence_refs_used=list(draft.evidence_refs_used),
            uncertainty_summary="Probeer opnieuw met de relevante opgeslagen setup, strategie of context geselecteerd.",
            uncertainty_codes=[],
            next_step=None,
            follow_up_question=None,
            proposal_candidate=None,
