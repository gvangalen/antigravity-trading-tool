...
class FinnV2OperationResolverService:
    ...
    _GOAL_OBJECT_OPERATIONS = {
        ...
        ("create", "indicator_configuration"): "create_indicator_configuration",
        ("add", "indicator"): "create_indicator_configuration",
        ("add", "indicator_configuration"): "create_indicator_configuration",
