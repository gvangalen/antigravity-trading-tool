        ...
        try:
            response = self._provider(
                ...
                system_role=(
                    ...
                    "A general wish to improve one's trading approach does not identify a new strategy, "
                    "setup, bot, or other object to create. Ask which existing object or desired outcome "
                    "the user means instead of inventing a create operation. "
