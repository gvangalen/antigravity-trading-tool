...
GOLDEN_FAMILIES = [
    ...
    ("READ", "read_setup", ["Welke setup is actief?", "Toon mijn actieve setup.", "Wat is mijn huidige BTC setup?", "Welke setup gebruik ik?", "Op welk timeframe draait mijn setup?"], ["active_setup"]),
