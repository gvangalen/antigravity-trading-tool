    ...
    <div className="relative w-full max-w-md mx-4" ref={containerRef}>
      <div className="relative group">
        ...
        <input
          ...
          placeholder="Zoek crypto of asset... (BTC, ETH, SOL)"
        ...
        {isOpen && query.trim() !== "" && filteredAssets.length === 0 && (
           ...
           >
              <div className="flex flex-col items-center gap-3">
                ...
                <div>
                  <div className="text-sm font-black text-slate-900 dark:text-white uppercase tracking-tight">Geen assets gevonden</div>
                  <div className="text-xs font-bold text-slate-400 mt-1">Probeer een ander symbool zoals BTC of ETH</div>
                </div>
              </div>
           </motion.div>
        )}
