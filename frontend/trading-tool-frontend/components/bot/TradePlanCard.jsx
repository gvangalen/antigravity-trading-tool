  ...
  return (
    <div className="rounded-[2rem] border border-[var(--color-border)] bg-card shadow-sm p-6 space-y-6 transition-colors duration-300">
      ...
      <div className="flex items-center justify-between">
        <div>
          <div className="text-[10px] font-black text-muted uppercase tracking-widest mb-1">Execution Plan</div>
          <div className="flex items-center gap-2">
            <h3 className="text-xl font-black text-foreground tracking-tight">Active Target Logic</h3>
        ...
        {Number.isFinite(livePrice) && (
          <div className="text-right">
            <div className="text-[9px] font-black text-muted uppercase tracking-tighter">Live Ticker</div>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="bg-[var(--color-border-subtle)] border border-[var(--color-border)] rounded-xl p-3 flex flex-col justify-center">
          <div className="text-[9px] font-black text-muted uppercase tracking-tighter mb-1">Risk Exposure</div>
      ...
      {loading && (
        <div className="absolute inset-0 bg-white/60 backdrop-blur-[1px] flex items-center justify-center rounded-2xl z-50">
           <div className="text-xs font-black text-secondary uppercase tracking-widest animate-pulse">Syncing Plan...</div>
        </div>
      )}
    </div>
  );
