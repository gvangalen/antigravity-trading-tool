  ...
  return (
    <div className="space-y-8 p-1">
      <div className="p-4 rounded-xl bg-blue-50 border border-blue-100 flex items-start gap-4 shadow-sm">
        <div className="p-2 rounded-lg bg-white text-blue-500 shadow-sm shrink-0">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="space-y-2">
          ...
          <input
            type="number"
            className="w-full bg-slate-50 border border-slate-200 rounded-2xl px-5 py-4 text-sm font-black text-slate-800 focus:ring-2 focus:ring-[var(--primary)] outline-none transition-all"
      ...
      <div className="space-y-4 pt-4 border-t border-slate-100">
        <div className="flex items-center justify-between">
          <label className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Asset Exposure Sensor</label>
        ...
        <div className="bg-slate-50 border border-slate-100 p-8 rounded-[2rem] shadow-inner">
          <TradingSlider
        ...
        <div className="text-[9px] font-bold text-slate-400 uppercase tracking-tight text-center italic">
