         ...
         <div className="space-y-8 relative z-10">
            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
               ...
               <div className="text-left sm:text-right">
                  <div className="text-[10px] font-black text-secondary/40 uppercase tracking-[0.2em] mb-1 sm:mb-2 leading-none">Macro Bias</div>
      ...
      <div className="bg-card rounded-[2.5rem] border border-[var(--color-border)] p-6 sm:p-10 flex flex-col justify-between shadow-[0_8px_30px_rgb(0,0,0,0.04)] relative overflow-hidden group h-full transition-all hover:shadow-[0_20px_50px_rgba(0,0,0,0.08)]">
         ...
         <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8 relative z-10">
            <div className="flex items-center gap-4">
               ...
               <div className="text-[10px] sm:text-[11px] font-bold uppercase tracking-[0.2em] text-secondary/60 leading-none">Structural Regime</div>
            </div>
         </div>

         <div className="relative z-10 space-y-3">
            <div className="text-[10px] sm:text-[11px] font-black text-blue-500 uppercase tracking-[0.25em]">Market Direction</div>
            ...
            <div className="py-3 px-4 rounded-xl bg-slate-50 dark:bg-slate-900/50 border border-[var(--color-border-subtle)]">
               <p className="text-[9px] sm:text-[10px] text-secondary/70 leading-relaxed font-bold uppercase tracking-wider">
                  Directional analysis indicates a {trend || "STABLE"} global macro regime based on multi-indicator synchronization.
               </p>
            </div>
         </div>
