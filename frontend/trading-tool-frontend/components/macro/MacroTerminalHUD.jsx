      ...
      <div className="md:col-span-2 bg-card rounded-[2rem] border border-slate-200 p-8 shadow-sm flex flex-col justify-between relative overflow-hidden group">
         ...
         <div className="flex items-center justify-between mb-8 relative z-10">
            <div className="flex items-center gap-3">
               ...
               <div>
                  <div className="text-[10px] font-black text-secondary uppercase tracking-widest">Aggregated Macro Sentiment</div>
                  <div className="text-xl font-black text-foreground tracking-tight uppercase">Global Macro Terminal</div>
               </div>
            </div>
         ...
         <div className="space-y-6 relative z-10">
            <div className="flex items-end justify-between">
               ...
               <div className="text-right">
                  <div className="text-[10px] font-bold text-secondary uppercase tracking-widest mb-1 italic">Macro Bias</div>
