...
export default function TechnicalTerminalHUD({ score, bias, trend, risk, loading = false }) {
  ...
  return (
    <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      {/* 🔮 MODULE 1: GLOBAL BIAS TERMINAL */}
      <div className="md:col-span-2 bg-card rounded-[2rem] border border-slate-200 p-8 shadow-sm flex flex-col justify-between relative overflow-hidden group">
         {/* DECORATIVE GRID */}
         ...
         <div className="flex items-center justify-between mb-8 relative z-10">
            <div className="flex items-center gap-3">
               ...
               <div>
                  <div className="text-[10px] font-black text-secondary uppercase tracking-widest">Sentiment</div>
                  <div className="text-xl font-black text-foreground tracking-tight uppercase">Overzicht</div>
               </div>
            </div>
         ...
         <div className="space-y-6 relative z-10">
            <div className="flex items-end justify-between">
               ...
               <div className="text-right">
                  <div className="text-[10px] font-bold text-secondary uppercase tracking-widest mb-1 italic">Current Bias</div>
                  <div className={`text-2xl font-black ${config.color} tracking-tighter`}>{bias || "STABLE"}</div>
               </div>
            </div>

            {/* THE BIAS BAR (V2 PRO STYLE) */}
            <div className="h-6 w-full bg-[var(--color-border-subtle)] rounded-lg p-1 border border-slate-200 overflow-hidden">
               <div 
      ...
      <div className="h-full">
         <div className="bg-card rounded-[2rem] border border-slate-200 p-8 flex flex-col justify-between h-full shadow-sm relative overflow-hidden group">
            ...
            <div className="flex items-center gap-3 mb-6 relative z-10">
               <div className="w-8 h-8 rounded-lg bg-[var(--color-border-subtle)] border border-slate-100 flex items-center justify-center">
                  <Activity size={16} className="text-blue-500" />
               </div>
               <div className="text-[9px] font-black uppercase tracking-[0.2em] text-slate-400">Marktfase</div>
            </div>

            <div className="relative z-10">
               <div className="text-xs font-black text-blue-500 uppercase mb-1">Richting</div>
               <div className="text-4xl font-black tracking-tighter uppercase leading-none mb-3 text-slate-800">
                  {trend || "ZIGZAG"}
               </div>
               <p className="text-[10px] text-muted leading-relaxed max-w-[220px] font-medium uppercase tracking-wider">
                  Fase: {trend || "STABIEL"}. Trend gedetecteerd op de belangrijkste tijdstippen.
               </p>
            </div>
            ...
            <div className="mt-8 relative z-10">
               <div className="flex items-center gap-2">
                  ...
                  <span className="text-[8px] font-black tracking-widest text-slate-300 uppercase">Live</span>
               </div>
            </div>
         </div>
      </div>
